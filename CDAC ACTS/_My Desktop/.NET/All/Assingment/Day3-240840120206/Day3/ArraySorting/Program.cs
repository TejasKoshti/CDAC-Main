namespace ArraySorting
{
    internal class Program
    {
        ...
        {
            Emp[] arr = new Emp[3];
            arr[0] = new Emp { EmpNo = 5, Name = "A", Basic = 1235, DeptNo = 10 };
            arr[1] = new Emp { EmpNo = 1, Name = "B", Basic = 1236, DeptNo = 20 };
            arr[2] = new Emp { EmpNo = 2, Name = "C", Basic = 1234, DeptNo = 30 };

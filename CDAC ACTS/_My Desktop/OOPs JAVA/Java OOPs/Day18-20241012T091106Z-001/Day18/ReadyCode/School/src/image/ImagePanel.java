...
{
	/**
	 * This class  demonstrates image operations in java
	...
	public ImagePanel() 
	{
		objImage = Toolkit.getDefaultToolkit().getImage("F:\\Sample_Repository\\Images\\JPGs\\Abdomen4.jpg");//Path_43_Year_Female_5.jpg");//"F:\\Personal\\MIGLogo.gif");

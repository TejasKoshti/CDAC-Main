...
public class LinkedHasMapTester {
	    ...
	    public static void main(String[] args) {
	        ...
	        Map<String, BookDetails> map = new LinkedHashMap<>();
	        ...
	        do {
	            ...
	            case 5:
	            {
	                ...
	                if (b != null) {
	                    System.out.println("Book removed successfully"); // Fixed spelling
	                } else {
	            ...
	            break;
	            case 6:
	                System.out.println("Thank you for Visiting 🙏"); // Fixed spelling
	                break;

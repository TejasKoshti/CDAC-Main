/* Implement constructor, parameterized constructor , Accept, Display
functions in Account class. Try to create Account objects using new
operator. Provide option to add an account to array for open account
and display account details. Print this pointer inside function to
check if it points to invoking object. Write menu driven program for
this. Find account and do transactions like withdraw and deposit.*/

...
public class UsersController {
	...
	public String checkUser(@Valid @ModelAttribute("objUser") Users objUsers, BindingResult result) {
		if (result.hasErrors()) {
			return "login";
		}else {
	...
	public ModelAndView authenticateUser(@ModelAttribute("objUser")Users objUsers) {
		if (objUsers.getUserName().equals("cdac") && objUsers.getPassword().equals("cdac")) {
